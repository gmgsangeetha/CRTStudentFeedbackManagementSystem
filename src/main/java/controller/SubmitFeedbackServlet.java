...
public class SubmitFeedbackServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        // Read other parameters from the form
        ...
        try {
            ...
            // ✅ AUTOMATIC RESET CHECK: Verifies if they submitted feedback TODAY
            ...
            // Insert feedback (created_at autogenerates)
            ...
            // Go to your success completion page
